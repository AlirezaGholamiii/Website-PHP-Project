...
define("BUYING_PAGE_PATH", "buy.php");
define("ACCOUNT_PAGE_PATH", "account.php");
...
function createNavigationMenu()
{
    ...
    ?>
            <nav>
                <a  href="<?php echo HOME_PAGE_PATH  ?>">Home</a>
                <a  href="<?php echo ORDERS_PAGE_PATH  ?>">Orders</a>
                <a  href="<?php echo BUYING_PAGE_PATH  ?>">Buy</a>
                <a  href="<?php echo ACCOUNT_PAGE_PATH  ?>">Account</a>
...
function CreateLoginPage()
{
    ...
    if(isset($_POST["login"]))
    {
        ...
        else if($customer->login($_POST["username"]) == false)
        {
            $errorUsername = "This username does not exist!";
            ?> <h2 class="top-message"> Username Is Not Correct!</h2> <?php 
        }
        else
        {
            ...
            else
            {
                ...
                ?> <h2 class="top-message"> Password Is Not Correct!</h2> <?php
            }
        }
    }
    else
    ...
    ?>
            ...
            <form  action="index.php" method="post">
                ...
                <input type="password" name="password"  placeholder="Your pass..." ><br>
                <span class="error">
              ...
              <div class="cheatSheet">  
                <a class="BtncheatSheet" href="register.php" >R e g i s t e r</a>
            </div>
            </form>
        </div>
    <?php
